...
<head>
  ...
  <title>Lounusa Beach Resort - About Us</title>
...
<body class="font-sans text-[#0B2530] bg-[#F4EFE6]">
  ...
  <header class="sticky top-0 z-50 bg-[#F4EFE6]/90 backdrop-blur-md shadow-sm">
    <div class="max-w-7xl mx-auto flex justify-between items-center px-8 py-4 relative">
      ...
      <nav class="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600">
        ...
        <a href="/profil" class="text-[#0B2530] border-b-2 border-[#0B2530] pb-1">About Us</a>
      ...
      <div id="contact-mobile-menu" class="hidden absolute top-full left-0 w-full bg-[#0B2530]/95 backdrop-blur-md border-b border-gray-800 shadow-xl py-4 px-8 flex flex-col space-y-4 text-xs tracking-widest uppercase text-white/90 font-light md:hidden transition-all duration-300">
        ...
        <a href="/profil" class="text-[#C2A878] py-1 ">About Us</a>
        <a href="/kamar-laut" class="hover:text-[#C2A878] py-1 border-gray-800/50">Rooms</a>
  ...
  <div class="relative bg-cover bg-center bg-no-repeat min-h-[440px] flex items-center justify-center overflow-hidden rounded-3xl mx-4 md:mx-8 mt-4 shadow-sm">
    <img src="<?php echo asset('images/about/lb.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
    ...
    <div class="relative z-10 text-center px-6 max-w-2xl">
      <h1 class="text-4xl md:text-5xl font-serif-lux text-white mb-3 tracking-wide drop-shadow-sm">
        About Lounusa Beach Resort
      </h1>
      <p class="text-xs md:text-sm text-[#F0DBB2] font-light tracking-wide max-w-md mx-auto drop-shadow-sm">
        EXPERIENCE A LUXURIOUS ESCAPE SURROUNDED BY COMFORT
      </p>
    </div>
  </div>
  ...
  <section class="max-w-6xl mx-auto px-6 py-24">
    <div class="grid md:grid-cols-12 gap-12 items-center">
      <div class="md:col-span-5">
        <span class="text-gray-400 text-[11px] font-semibold uppercase tracking-widest block mb-2">Our Story</span>
        <h2 class="text-3xl md:text-4xl font-serif-lux text-[#0B2530] leading-tight mb-6">
          A Vision of Coastal Harmony
        </h2>
        <p class="text-xs text-gray-600 leading-relaxed font-light mb-4">
          Lounusa Beach Resort was built with a simple vision: to create a peaceful retreat where guests can reconnect with nature while enjoying modern comfort.
        </p>
        <p class="text-xs text-gray-600 leading-relaxed font-light">
          Located above crystal-clear waters, our resort offers endless ocean views, gentle sea breezes, and a peaceful atmosphere—perfect for relaxation and unforgettable moments.
        </p>
      </div>
      
      <div class="md:col-span-7 flex justify-end relative">
        <div class="relative w-full max-w-[500px] aspect-[4/5] rounded-3xl overflow-hidden shadow-sm">
          <img src="<?php echo asset('images/about/lb1.jpg'); ?>" class="w-full h-full object-cover" />
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="bg-white py-24 px-6">
    <div class="max-w-6xl mx-auto">
      <div class="text-center mb-16">
        <span class="text-gray-400 text-[10px] font-semibold uppercase tracking-widest block mb-2">THE RESORT EXPERIENCE</span>
        <h3 class="text-3xl font-serif-lux text-[#0B2530]">The Experience</h3>
      </div>

      <div class="grid md:grid-cols-3 gap-8">
        <div class="border border-gray-100 rounded-2xl p-8 bg-[#F4EFE6]/30 shadow-[0_4px_20px_rgba(0,0,0,0.01)] text-center flex flex-col items-center">
          <div class="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[#2C7A7B] shadow-sm mb-6">
          ...
          <h4 class="text-base font-semibold text-[#0B2530] mb-3">Nature & Serenity</h4>
          <p class="text-xs text-gray-400 font-light leading-relaxed">
            Embrace the calm of nature with gentle ocean waves, soft sea breeze, and tropical views that soothe every moment of your stay.
          </p>
        </div>
        ...
        <div class="border border-gray-100 rounded-2xl p-8 bg-[#F4EFE6]/30 shadow-[0_4px_20px_rgba(0,0,0,0.01)] text-center flex flex-col items-center">
          ...
          <h4 class="text-base font-semibold text-[#0B2530] mb-3">Comfort & Privacy</h4>
          <p class="text-xs text-gray-400 font-light leading-relaxed">
            Experience exceptional comfort in thoughtfully designed spaces that offer privacy, relaxation, and a warm coastal ambiance.
          </p>
        </div>

        <div class="border border-gray-100 rounded-2xl p-8 bg-[#F4EFE6]/30 shadow-[0_4px_20px_rgba(0,0,0,0.01)] text-center flex flex-col items-center">
          <div class="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[#2C7A7B] shadow-sm mb-6">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M14 12a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
          </div>
          <h4 class="text-base font-semibold text-[#0B2530] mb-3">Tranquil Ocean Escape</h4>
          <p class="text-xs text-gray-400 font-light leading-relaxed">
            Unwind by the shoreline and discover your perfect seaside escape, where golden sunsets and peaceful moments create unforgettable memories.
          </p>
        </div>
      </div>
    </div>
  ...
  <section class="max-w-6xl mx-auto px-6 py-24">
    <div class="flex justify-between items-end mb-10">
      <div>
        <span class="text-gray-400 text-[11px] font-semibold uppercase tracking-widest block mb-2">OUR GALLERY PORTFOLIO</span>
        <h3 class="text-3xl font-serif-lux text-[#0B2530]">Gallery</h3>
      </div>
      <div class="flex gap-2">
        <button class="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center text-gray-400 hover:border-[#0B2530] hover:text-[#0B2530] text-sm transition">&lsaquo;</button>
        <button class="w-8 h-8 rounded-full border border-gray-300 flex items-center justify-center text-gray-400 hover:border-[#0B2530] hover:text-[#0B2530] text-sm transition">&rsaquo;</button>
      </div>
    </div>

    <div class="grid md:grid-cols-12 gap-6">
      
      <div class="md:col-span-7 relative rounded-3xl overflow-hidden shadow-sm aspect-[4/3] group">
        <img src="<?php echo asset('images/gallery/lb.jpg'); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
        <div class="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent p-8 pt-20 flex flex-col justify-end">
          <h4 class="text-white font-serif-lux text-xl mb-1">Discover Paradise | Lounusa Beach Resort</h4>
          <span class="text-xs text-white/70 font-light uppercase tracking-wider mb-3">About Us</span>
          <p class="text-[11px] text-white/80 font-light leading-relaxed max-w-md hidden sm:block">Any corner of our resort offers natural beauty and outstanding luxury at its dynamic level. Experience the authentic beauty of Maluku coastline raw, pristine and untouched.</p>
          <a href="#" class="text-[10px] text-white font-semibold tracking-wider uppercase underline mt-4 block">Learn More</a>
        </div>
      </div>

      <div class="md:col-span-5 grid grid-rows-2 gap-6">
        <div class="rounded-3xl overflow-hidden shadow-sm aspect-[16/10]">
          <img src="<?php echo asset('images/gallery/sore-saat-air-surut.jpg'); ?>" class="w-full h-full object-cover" />
        </div>
        <div class="rounded-3xl overflow-hidden shadow-sm aspect-[16/10]">
          <img src="<?php echo asset('images/gallery/teras.jpg'); ?>" class="w-full h-full object-cover" />
        </div>
      </div>
  ...
  <section class="bg-[#0B2530] text-center text-white py-20 px-6 mx-4 md:mx-8 rounded-3xl shadow-sm">
    ...
    <p class="text-xs text-gray-300 max-w-lg mx-auto mb-8 font-light leading-relaxed">
      Contact us directly for more information and reservations. Experience the pinnacle of coastal serenity.
    </p>
