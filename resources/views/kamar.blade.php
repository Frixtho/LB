...
<body class="font-sans text-[#0B2530] bg-[#F4EFE6]">
  ...
  <header class="sticky top-0 z-50 bg-[#F4EFE6]/90 backdrop-blur-md shadow-sm">
    <div class="max-w-7xl mx-auto flex justify-between items-center px-8 py-4 relative">
      ...
      <div id="contact-mobile-menu" class="hidden absolute top-full left-0 w-full bg-[#0B2530]/95 backdrop-blur-md border-b border-gray-800 shadow-xl py-4 px-8 flex flex-col space-y-4 text-xs tracking-widest uppercase text-white/90 font-light md:hidden transition-all duration-300">
        <a href="/home" class="hover:text-[#C2A878] py-1  border-gray-800/50">Home</a>
  ...
  <div class="flex justify-center gap-4 mt-12 mb-10">
    <!-- Tombol Kamar Atas Laut menjadi putih (tidak aktif) -->
    <a href="/kamar-laut" class="px-6 py-2 rounded-full text-xs font-semibold uppercase tracking-wider bg-white text-gray-500 hover:text-[#0B2530] hover:bg-gray-100 transition shadow-sm text-center inline-block border border-gray-200">
      Kamar Atas Laut
    </a>
    
    <!-- Tombol Kamar Darat menjadi gelap/navy (aktif) -->
    <a href="/kamar" class="px-6 py-2 rounded-full text-xs font-semibold uppercase tracking-wider bg-[#0B2530] text-white transition shadow-sm text-center inline-block">
      Kamar Darat
    </a>
  </div>

  <!-- ================= ROOMS LIST ================= -->
  <section class="max-w-6xl mx-auto px-6 pb-24 space-y-10">

    <!-- KAMAR 1: MOMAR (Gambar Kiri, Teks Kanan) -->
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px]">
      <div class="md:col-span-5 h-full relative min-h-[240px] md:min-h-full overflow-hidden">
        <div class="flex h-full room-slider" data-index="0">
          <img src="<?php echo asset('images/kamarDarat/momar/kamar1.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
        </div>
        <span class="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">Basic Room</span>
      </div>
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Momar</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
        ...
        <div class="flex justify-between items-end mt-4">
          <div>
            <span class="text-[10px] text-gray-400 block uppercase tracking-wider">Mulai Dari</span>
            <span class="text-lg font-semibold text-[#0B2530]">Rp 150.000</span><span class="text-xs text-gray-400"> / malam</span>
          </div>
          <a href="https://wa.me/6285388882379" target="_blank" class="w-10 h-10 rounded-full bg-[#2C7A7B] flex items-center justify-center text-white hover:bg-opacity-90 transition shadow-sm">
    ...
    <!-- KAMAR 2: KAWALINYA (Gambar Kanan, Teks Kiri) -->
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px]">
      <div class="md:col-span-7 p-8 md:p-10 order-2 md:order-1 h-full flex flex-col justify-between">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Kawalinya</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
      ...
      <div class="md:col-span-5 h-full relative min-h-[240px] md:min-h-full order-1 md:order-2 overflow-hidden">
        <div class="flex h-full room-slider" data-index="0">
          <img src="<?php echo asset('images/kamarDarat/momar/kamar.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
        </div>
        <span class="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">Basic Room</span>
      </div>
    </div>

    <!-- KAMAR 3: TATIHU (Gambar Kiri, Teks Kanan) -->
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px]">
      <div class="md:col-span-5 h-full relative min-h-[240px] md:min-h-full overflow-hidden">
        <div class="flex h-full room-slider" data-index="0">
          <img src="<?php echo asset('images/kamarDarat/tatihu/kamar1.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
        </div>
        <span class="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">Basic Room</span>
      </div>
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Tatihu</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
        ...
        <div class="flex justify-between items-end mt-4">
          <div>
            <span class="text-[10px] text-gray-400 block uppercase tracking-wider">Mulai Dari</span>
            <span class="text-lg font-semibold text-[#0B2530]">Rp 220.000</span><span class="text-xs text-gray-400"> / malam</span>
          </div>
          <a href="https://wa.me/6285388882379" target="_blank" class="w-10 h-10 rounded-full bg-[#2C7A7B] flex items-center justify-center text-white hover:bg-opacity-90 transition shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12 3 7.582 7.03 4 12 4s9 3.582 9 8z" />
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px] mb-10 room-section" data-room="darat">
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between md:order-1 order-2">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Lalosi</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
      ...
      <div class="md:col-span-5 h-full relative min-h-[240px] md:min-h-full overflow-hidden md:order-2 order-1">
        <div class="flex h-full room-slider" data-index="0">
          <img src="<?php echo asset('images/kamarDarat/momar/kamar.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
        </div>
        <span class="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">Basic Room</span>
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px] mb-10 room-section" data-room="darat">
      ...
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Cekalang</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px] mb-10 room-section" data-room="darat">
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between md:order-1 order-2">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Samandar</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px] mb-10 room-section" data-room="darat">
      <div class="md:col-span-5 h-full relative min-h-[240px] md:min-h-full overflow-hidden">
        <div class="flex h-full room-slider" data-index="0">
          <img src="<?php echo asset('images/kamarDarat/momar/kamar2.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
        </div>
        <span class="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">Basic Room</span>
      </div>
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Gajahmerah</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px] mb-10 room-section" data-room="darat">
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between md:order-1 order-2">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Tengiri</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
            <span>Two Double Beds</span> <span>•</span> <span>Spacious Room</span> <span>•</span> <span>Private Bathroom</span> <span>•</span> <span>Air Conditioner</span> <span>•</span> <span>Water Heater</span> <span>•</span> <span>Free Wi-Fi</span>
          </div>
        </div>
        <div class="flex justify-between items-end mt-4">
          <div>
            <span class="text-[10px] text-gray-400 block uppercase tracking-wider">Mulai Dari</span>
            <span class="text-lg font-semibold text-[#0B2530]">Rp 250.000</span><span class="text-xs text-gray-400"> / malam</span>
          </div>
          <a href="https://wa.me/6285388882379" target="_blank" class="w-10 h-10 rounded-full bg-[#2C7A7B] flex items-center justify-center text-white hover:bg-opacity-90 transition shadow-sm">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12 3 7.582 7.03 4 12 4s9 3.582 9 8z" />
      ...
      <div class="md:col-span-5 h-full relative min-h-[240px] md:min-h-full overflow-hidden md:order-2 order-1">
        <div class="flex h-full room-slider" data-index="0">
          <img src="<?php echo asset('images/kamarDarat/sikuda/kamar.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
        </div>
        <span class="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">Standard Room</span>
      </div>
    </div>
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px] mb-10 room-section" data-room="darat">
      <div class="md:col-span-5 h-full relative min-h-[240px] md:min-h-full overflow-hidden">
        <div class="flex h-full room-slider" data-index="0">
          <img src="<?php echo asset('images/kamarDarat/geropa/kamar.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
        </div>
        <span class="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">Standard Room</span>
      </div>
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Geropa</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px] mb-10 room-section" data-room="darat">
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between md:order-1 order-2">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Sikuda</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 grid md:grid-cols-12 items-center min-h-[320px] mb-10 room-section" data-room="darat">
      <div class="md:col-span-5 h-full relative min-h-[240px] md:min-h-full overflow-hidden">
        <div class="flex h-full room-slider" data-index="0">
          <img src="<?php echo asset('images/kamarDarat/bolana/kamar.jpg'); ?>" class="w-full h-full object-cover absolute inset-0" />
        </div>
        <span class="absolute top-4 left-4 bg-black/40 backdrop-blur-sm text-white text-[10px] tracking-wider uppercase px-3 py-1 rounded-full">Standard Room</span>
      </div>
      <div class="md:col-span-7 p-8 md:p-10 relative h-full flex flex-col justify-between">
        <div>
          <h3 class="text-2xl font-serif-lux text-[#0B2530] mb-3">Bolana</h3>
          <p class="text-xs text-gray-500 leading-relaxed mb-4 max-w-xl">
            Designed for families, this room provides ample space and comfort for a relaxing stay together.
          </p>
          <div class="flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-gray-400 font-medium uppercase tracking-wider mb-6">
    ...
    <!-- *Catatan: Anda dapat melanjutkan pola berselang-seling ini untuk Kamar 4 sampai Kamar 11 sesuai kebutuhan data Anda.* -->
  ...
  <!-- Floating Chat Button di Sudut Halaman -->
